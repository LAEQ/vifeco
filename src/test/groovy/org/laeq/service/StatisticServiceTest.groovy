...
//        String tarjansDiffSerialized = new ObjectMapper().writeValueAsString(tarjansDiff)
//        String tarjansSerialized = new ObjectMapper().writeValueAsString(tarjans)
//
//        println tarjansDiffSerialized
//        println tarjansSerialized
