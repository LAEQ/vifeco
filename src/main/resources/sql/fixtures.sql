INSERT INTO user (ID, FIRST_NAME, LAST_NAME, EMAIL, IS_LOGGED_IN) VALUES (NEXT VALUE FOR user_id, 'Luck', 'Skywalker', 'luke@maytheforcebewithyou.com', true);
INSERT INTO user (ID, FIRST_NAME, LAST_NAME, EMAIL, IS_LOGGED_IN) VALUES (NEXT VALUE FOR user_id, 'Darth', 'Vador', 'darth@iamyourfather.com', false);
INSERT INTO user (ID, FIRST_NAME, LAST_NAME, EMAIL, IS_LOGGED_IN) VALUES (NEXT VALUE FOR user_id, 'Leia', 'Organa', 'leia@areyoualittleshortforastormtrooper.com', false);
INSERT INTO user (ID, FIRST_NAME, LAST_NAME, EMAIL, IS_LOGGED_IN) VALUES (NEXT VALUE FOR user_id, 'Han', 'Solo', 'han@bestpilotinthegalaxy.com', false);
